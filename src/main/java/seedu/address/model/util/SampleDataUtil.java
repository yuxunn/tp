    ...
    public static Person[] getSamplePersons() {
        return new Person[] {
            ...
            new Client(new Name("Bernice Yu"), new Phone("99272758"), new Email("berniceyu@example.com"),
                new Address("Blk 30 Lorong 3 Serangoon Gardens, #07-18"), Optional.of(new MeetingTime("10/10/2023 14:30")),
                getTagSet("colleagues", "friends")),
            new Client(new Name("Charlotte Oliveiro"), new Phone("93210283"), new Email("charlotte@example.com"),
                new Address("Blk 11 Ang Mo Kio Street 74, #11-04"), Optional.of(new MeetingTime("10/10/2023 14:30")),
                getTagSet("neighbours")),
            new Lead(new Name("David Li"), new Phone("91031282"), new Email("lidavid@example.com"),
                new Address("Blk 436 Serangoon Gardens Street 26, #16-43"), Optional.of(new MeetingTime("10/10/2023 14:30")),
                getTagSet("family")),
