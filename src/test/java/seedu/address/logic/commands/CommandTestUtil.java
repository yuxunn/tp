...
public class CommandTestUtil {
    ...
    public static final String VALID_MEETING_TIME_AMY = "10/10/2024 10:00";
    ...
    public static final String KEY_MILESTONE_DESC_BOB = " " + PREFIX_KEYMILESTONE + VALID_KEY_MILESTONE_BOB;
