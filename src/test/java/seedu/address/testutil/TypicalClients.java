...
public class TypicalClients {
    ...
    public static final Client CARL = new PersonBuilder().withName("Carl Kurz").withPhone("95352563")
            .withEmail("heinz@example.com").withAddress("wall street").withMeetingTime("24/10/2023 12:30").buildClient();
    public static final Client DANIEL = new PersonBuilder().withName("Daniel Meier").withPhone("87652533")
            .withEmail("cornelia@example.com").withAddress("10th street").withTags("friends").withMeetingTime("24/10/2023 12:30").buildClient();
    public static final Client ELLE = new PersonBuilder().withName("Elle Meyer").withPhone("9482224")
            .withEmail("werner@example.com").withAddress("michegan ave").withMeetingTime("24/10/2023 12:30").buildClient();
    public static final Client FIONA = new PersonBuilder().withName("Fiona Kunz").withPhone("9482427")
            .withEmail("lydia@example.com").withAddress("little tokyo").withMeetingTime("24/10/2023 12:30").buildClient();
    ...
    public static final Client HOON = new PersonBuilder().withName("Hoon Meier").withPhone("8482424")
            .withEmail("stefan@example.com").withAddress("little india").withMeetingTime("24/10/2023 12:30").buildClient();
     ...
     */
    public static AddressBook getTypicalClientsAddressBook() {
